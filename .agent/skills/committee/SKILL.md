...
让 Gemini、Claude、Deepseek 基于同一份客观数据独立分析，必要时交叉验证，最终提取可执行共识。
...
- `Committee/Opinions/Gemini.md` (Self)
- `Committee/Opinions/Claude.md`
- `Committee/Opinions/Deepseek.md`
...
- `Committee/Opinions/Deepseek-R2.md`
